...
<div class="main-wrapper">
	<h2>Allow Access?</h2>
	<p class="request-description"><strong><?php echo $client['post_title']; ?></strong> would like to access and/or update your account.</p>
