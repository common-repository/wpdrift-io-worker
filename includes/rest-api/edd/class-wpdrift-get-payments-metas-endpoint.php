<?php
/**
 * EDD_GetPayments_Metas_Endpoint class
 *
 * @category Edd
 * @package  Edd
 ...
 * @since    1.0.0
 */
class EDD_GetPayments_Metas_Endpoint extends WP_REST_Controller
{
    /**
     * Constructor.
     *
    ...
    public function __construct()
    {
        ...
        $this->rest_base = 'getpayments-metas';
    }
    ...
    public function getItems($request)
    {
        ...
        $items = array();
        $items['edd_payments_metas'] 
            = $this->retrieveEddPaymentsMetas($parameters);
        $data = array();
